	...
	public static void main(String[] args) {
		...
		if (alltests || test == 6 || test == 7 || test == 8 || test == 9)
			try {
				...
				System.out.println("Test 6 failed try catch");
			}
		...
		if (alltests || test == 7)
			try {
				...
				System.out.println("Test 7 failed try catch");
			}
		...
		if (alltests || test == 8)
			try {
				...
				System.out.println("Test 8 failed try catch");
			}
		...
		try {
			...
			BufferedReader in = new BufferedReader(new FileReader("codeProvided/large.txt"));
